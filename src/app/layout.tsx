...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Elite Healthcare & Community Services", description: "Personalised NDIS support designed around your goals, choices and independence.", url: "/", siteName: "Elite HCS", locale: "en_AU", type: "website", images: [{ url: "/images/elite-care.jpg", width: 1200, height: 630, alt: "Elite Healthcare and Community Services" }] },
  twitter: { card: "summary_large_image", title: "Elite Healthcare & Community Services", description: "Participant-centred NDIS supports across four Australian states and territories.", images: ["/images/elite-care.jpg"] },
